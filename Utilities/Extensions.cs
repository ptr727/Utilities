...
public static class Extensions
{
    ...
    public static string Compress(this string uncompressedString) => StringCompression.Compress(uncompressedString);

    public static string Decompress(this string compressedString) => StringCompression.Decompress(compressedString);
