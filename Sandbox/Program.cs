...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
    ...
    public class FfProbePipeProcess : ProcessEx 
    {
        public bool Run()
        {
            ...
            const string cmdLine = $"-loglevel error -show_packets -of json \"{targetFile}\"";
            RedirectOutput = true;
            RedirectError = true;
    ...
    public class FfProbeProcess : ProcessEx
    {
        ...
        private bool JsonHeaderFound;
        private bool JsonFooterFound;
    }
    ...
    private static void TestSerilog()
    {
        ...
        Microsoft.Extensions.Logging.ILogger logger = programLogger;
